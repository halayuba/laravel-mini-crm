  ...
  <div class="min-h-screen container mx-auto px-2 xl:px-4 py-4 xl-py-12 xl:mt-8">
    ...
    <div class="mt-4 xl:mt-8 container mx-auto px-2 xl:px-8">
      ...
      <ul class="px-2 text-gray-700">
        ...
        <li class="leading-loose list-decimal">Migrations to create schema and DB structure and Seeders (including factories: "App\Database\factories") are used to pre-populate certain tables.</li>
