  ...
  <div class="min-h-screen container mx-auto px-2 xl:px-4 py-4 xl-py-12 xl:mt-8">
    ...
    <div class="mt-4 xl:mt-8 container mx-auto px-2 xl:px-8">
      ...
      <ul class="px-2 text-gray-700">
        ...
        <li class="leading-loose list-decimal">The "ProcessFileUpload" repository is used to validate and store uploaded files to local storage folder that is publicly accessible.</li>
        <li class="leading-loose list-decimal">Mini CRM contains many essential concepts: using Filters ("App\Filters"), Form validation ("App\Http\Requests"), scope (in Models), view composer ("App\Providers\AppServiceProvider"), blade service provider (""App\Providers\BladeServiceProvider"), markdown mail ("App\Mail\AccessToCompanyGranted"), flash messages (""), pagination, and helper functions are used in this mini CRM application.</li>
