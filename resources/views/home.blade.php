...
@section('content')
  ...
  <div class="min-h-screen container mx-auto px-2 xl:px-4 py-4 xl-py-12 xl:mt-8">
    <div class="flex flex-col items-center ">
        ...
        <h3 class="text-lg text-grey-darker font-sans">This is a basic Laravel demo application, mainly CRUD with an implementation of authorization and access permissions management to restrict user actions.</h3>
    </div>
    ...
    <div class="mt-4 xl:mt-8 container mx-auto px-2 xl:px-8">
      ...
      <ul class="px-2 text-grey-darker">
        ...
        <li class="leading-loose">Seeders (including factories) are used to pre-populate certain tables.</li>
        ...
        <li class="leading-loose">Form validation, scope (in Models), view composer, blade service provider, markdown mail, flash messaging, and helper functions are used in this tool.</li>
